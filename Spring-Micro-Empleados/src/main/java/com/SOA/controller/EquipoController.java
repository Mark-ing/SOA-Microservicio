...
public class EquipoController {
	...
	public EquipoDTO registrar(@Valid @RequestBody EquipoDTO equipo) throws Exception{
		Equipo bean=null;
	...
	public EquipoDTO actualizar(@Valid @RequestBody EquipoDTO equipo) throws Exception{
		Equipo bean=null;
		bean=mapper.map(equipo, Equipo.class);

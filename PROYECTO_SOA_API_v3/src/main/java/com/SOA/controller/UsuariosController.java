...
public class UsuariosController {
	...
	public UsuariosDTO registrar(@Valid @RequestBody UsuariosDTO us) throws Exception{
		Usuarios bean=null;
	...
	public UsuariosDTO actualizar(@Valid @RequestBody UsuariosDTO us) throws Exception{
		Usuarios bean=null;
		bean=mapper.map(us, Usuarios.class);
